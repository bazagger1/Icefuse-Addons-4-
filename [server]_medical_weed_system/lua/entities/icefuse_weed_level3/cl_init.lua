...
File Path:   addons/[server]_medical_weed_system/lua/entities/icefuse_weed_level3/cl_init.lua
...
//=======================================================================//
	...
	cam.Start3D2D(pos, angle, 0.15 / SCALE)
		...
		surface.SetDrawColor(0, 204, 68, 255 * opacity)
		...
		draw.SimpleText("Weed timer" or actualtime, 'ph_TrebuchetC',
