...
File Path:   addons/[server]_food/lua/entities/icefuse_food_1_balloon_poodle/shared.lua
...
ENT.PrintName 	= "Balloon Poodle"
ENT.WorldModel  = "models/balloons/balloon_dog.mdl"
ENT.Charges	 	= 1
ENT.IsFood 		= true
ENT.HealMax 	= 40
ENT.HealAmount 	= 1
