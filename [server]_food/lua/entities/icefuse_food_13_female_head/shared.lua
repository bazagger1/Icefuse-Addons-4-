...
File Path:   addons/[server]_food/lua/entities/icefuse_food_13_female_head/shared.lua
...
ENT.PrintName 	= "Female Head"
ENT.WorldModel  = "models/maxofs2d/balloon_mossman.mdl"
ENT.Charges	 	= 1
ENT.IsFood 		= true
ENT.HealMax 	= 95
ENT.HealAmount 	= 20
