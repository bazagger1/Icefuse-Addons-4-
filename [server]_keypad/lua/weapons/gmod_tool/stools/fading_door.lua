...
File Path:   addons/[server]_keypad/lua/weapons/gmod_tool/stools/fading_door.lua
...
function TOOL:LeftClick(tr)
	...
	-- Don't interact with the fucking permapropped stuff, god dammit!
	-- This restriction was built for curious staff members that mess with tools (elite administrator and above), preventing them from altering the permapropped entities. You are welcome (Psyche).
	-- Only superadmins (developer+) should be able to interact with these objects..
	if ( tr.Entity:GetClass() == "vault_money") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "sent_dumpster") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "foodmachine") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "npc_accessory_vendor") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "mn_npc") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "the_opium_buyer") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "zmlab_methbuyer") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "the_crack_npc") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "chopshop") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "freshcardealer") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "undercover_npc") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
	if ( tr.Entity:GetClass() == "npc_bailer") and ( self:GetOwner():IsSuperAdmin() == false ) then self:GetOwner():EmitSound("buttons/button10.wav") return false end
