...
File Path:   addons/[server]_keypad/lua/weapons/gmod_tool/stools/keypad_willox.lua
...
function TOOL:RightClick(tr)
	...
	if tr.Entity:IsVehicle() then self:GetOwner():EmitSound("buttons/button10.wav") return false end --Icefuse Networks Development (Psyche): Vehicle material prevention ;)
